...
pub static REMAIN: Lazy<Arc<FileIndexResult>> = Lazy::new(|| Arc::new(FileIndexResult::Remain));
pub static SKIP: Lazy<Arc<FileIndexResult>> = Lazy::new(|| Arc::new(FileIndexResult::Skip));
