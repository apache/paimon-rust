...
//! FileIOProvider trait for abstracting file I/O operations.
//!
//! This trait allows different FileIO implementations (e.g., standard FileIO,
...
pub trait FileIOProvider: Send + Sync + std::fmt::Debug {
