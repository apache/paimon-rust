...
mod tests {
    ...
    async fn java_generated_v1_golden_is_bidirectionally_compatible() {
        // Generated by scripts/generate-fm-index-v1-golden.sh using Paimon's Java writer.
        let golden = general_purpose::STANDARD
            .decode(include_str!("fmindex-v1-golden.base64").trim())
            .unwrap();
