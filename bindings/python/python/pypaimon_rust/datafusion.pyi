...
class BatchTableUpdate:
    ...
    def new_update_by_row_id(self) -> TableUpdateByRowId: ...
    def update_by_arrow_with_row_id(self, table: pyarrow.Table) -> List[CommitMessage]: ...
    def update_by_arrow_batches_with_row_id(
        self, tables: Iterable[pyarrow.Table]
    ) -> List[CommitMessage]: ...
...
class TableUpdateByRowId:
    def update_columns(self, data: pyarrow.Table, column_names: List[str]) -> List[CommitMessage]:
        """Stage one input table; return the cumulative messages to commit once."""
        ...
    @property
    def commit_messages(self) -> List[CommitMessage]: ...
...
class StreamTableUpdate:
    ...
    def new_update_by_row_id(self, commit_identifier: int) -> TableUpdateByRowId: ...
    def update_by_arrow_with_row_id(
        self, table: pyarrow.Table, commit_identifier: int
    ) -> List[CommitMessage]: ...
    def with_update_type(self, update_cols: List[str]) -> "StreamTableUpdate": ...
