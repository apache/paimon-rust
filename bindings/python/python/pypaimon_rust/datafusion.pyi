...
class _MatchedBatchUpdateWriter:
...
class TableUpdateByRowId:
    ...
    def _pin_read_snapshot(self, snapshot_id: int) -> None: ...
...
class BatchWriteBuilder:
    ...
    def _new_matched_update(self, update_cols: List[str]) -> _MatchedBatchUpdateWriter: ...
