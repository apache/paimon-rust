...
def planning_capabilities() -> List[str]:
    """Named planning behaviors guaranteed by this runtime."""
    ...
...
class TableScan:
    ...
    def plan(self) -> Plan: ...
    def plan_with_trace(self) -> tuple[Plan, Dict[str, Union[int, bool, None]]]:
        """Return the plan and raw core metadata-planning counters, preserving names and units."""
        ...
